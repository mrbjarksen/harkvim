vim.cmd.packadd 'neo-tree-diagnostics.nvim'

local commands = require'harkvim.plugins.neo-tree.commands'
...
require'neo-tree'.setup {
  ...
  default_component_configs = {
    indent = {
      with_expanders = true,
      expander_collapsed = require'harkvim.icons'.misc.collapsed,
      expander_expanded = require'harkvim.icons'.misc.expanded,
    },
    icon = {
      folder_closed = require'harkvim.icons'.filesystem.closed_folder,
      folder_open   = require'harkvim.icons'.filesystem.open_folder,
      folder_empty  = require'harkvim.icons'.filesystem.empty_folder,
    },
  },
  renderers = {
    message = {
...
require'harkvim.keymaps'.neotree()
